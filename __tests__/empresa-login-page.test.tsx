...
describe("EmpresaLoginClient", () => {
    ...
    it("renders a direct company login surface", () => {
        ...
        expect(screen.getByRole("link", { name: "Fazer Avaliação" })).toHaveAttribute("href", "/avaliacao");
        expect(screen.getByRole("link", { name: "/agency/login" })).toHaveAttribute("href", "/agency/login");
        expect(screen.getByRole("link", { name: "Continuar para minha área" })).toHaveAttribute("href", "/org/acme/admin");
    });
